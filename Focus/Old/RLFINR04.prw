...
Private c_Perg  := "RLFIN1"  // Grupo de pergunta que sera criado no SX1
Private l_Ret	:= .F.
  
MsgINFO('Esse relatório precisa ser Validado, chamado ID 44625 - Este Relatório DESCONSIDERA os TIPOS NCC, RC, NDC, PR','VR 30-09a')

//Tela Inicial
Define MsDialog oDlg Title 'Relatório Extrato Bancário - Vr 3009a' From 7,10 To 15,55	Of oMainWnd              
...
If MV_PAR13 == 1
	c_QryAux +="AND		E1_TIPO NOT IN ('NCC','RC','NDC','PR') 																		"	+ c_EOL
Else
	c_QryAux +="AND		E1_TIPO NOT IN ('NCC','RC','NDC','PR','PA') 																"	+ c_EOL
EndIf
If MV_PAR14 == 2
	c_QryAux +="AND		E1_TIPO NOT IN ('RA') 																						"	+ c_EOL
EndIf
...
aAdd(aRegs,{c_Perg,"15","Imprime em: 				?","","","mv_chf","N",01,0,0,"C","","mv_par15","1.CSV","","","","","2.XLS","","","","","","","","","","","","","","","","","","",""})
